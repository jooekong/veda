...
- `POST /v1/search`、`POST /v1/grep`、`POST /v1/sql`、`POST /v1/answer`、`GET /v1/index-status`、`GET /v1/layout`、`GET /v1/abstract/{path}`、`GET /v1/overview/{path}`、`/v1/fs/*`、`/v1/events`、`/v1/collections/*`、`/v1/memory/*`（团队记忆）、`POST /mcp`（MCP 端点）
