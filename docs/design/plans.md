...
| 计划 | 状态 |
| --- | --- |
| [`agent-memory-m2a.md`](../plans/agent-memory-m2a.md) | Agent/团队记忆 M2a：answer 双源（记忆=第二证据源+出处一类）；**开工 08-13**；M1 已上线三节点（0.1.27）并归档；M2b 等案例；架构定稿 [`design/agent-memory.md`](agent-memory.md) |
